...
class wspc {
  ...
  public:
    ...
    sdouble neg_loglik(
        ...
        // Compute the negative log-likelihood of the point warping factors, given the assumed beta distribution
    ...
    List check_parameter_feasibility(
    ...
    // Wrap neg_loglik in form needed for R
    NumericVector grad_bounded_nll_debug(
        const dVec& x 
      ) { 
