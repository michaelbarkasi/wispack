...
<h2>Coordinate transform into axis of interest</h2>
...
6. **timeseries:** a fixed-effects factor to treat as a time series, typically developmental or experimental time points ([optional](articles/tutorial_timeseries.html)).
...
<h2>Spatial parameterization and warping</h2>
