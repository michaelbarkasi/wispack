...
author: "Michael Barkasi, Cody Nhan Pham"
...
1. Xcode developer tools: In terminal, run `xcode-select --install` and follow the instructions
2. GNU Fortran compiler: Go to https://mac.r-project.org/tools/, then download and run the relevant gfortran-[version]-universal.pkg
...
Rebuild and cleanly install Rcpp and Stan, in R: `install.packages(c("Rcpp", "RcppEigen", "RcppParallel", "StanHeaders"))`
