...
\[z \mapsto z + \sum_{l=1}^{m} (\beta_{T_l} + \text{interaction terms for }i)\]
...
with the stipulation that, if $\xi_{T_m}=1$ for some sampled data point, then for that data point $\xi_{T_l}=1$ for all $i<m$. 
